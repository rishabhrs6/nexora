...
export default function NexoraOS() {
  ...
  const glowX = useTransform(springY, [-8, 8], ["35%", "65%"]);
  const glowY = useTransform(springX, [-8, 8], ["35%", "65%"]);
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute h-72 w-72 -translate-x-1/2 -translate-y-1/2 rounded-full bg-cyan-500/20 blur-[120px]"
      />
